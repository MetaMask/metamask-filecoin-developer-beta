...
export default class IpfsEnable extends PureComponent {
  ...
  componentDidMount() {
    const { ipfsIpnsEnabled, ipfsIpnsHandlerShouldUpdate } = this.props;
            ...
            <div className="ipfs-enable__content">
              ...
              <div className="ipfs-enable__content-row">
                <div className="ipfs-enable__content-item">
                  <span>{t('ipfsIpnsResolvingTitle')}</span>
                ...
                <div className="ipfs-enable__content-item">
                  <span>{t('example')}</span>
                  <div className="ipfs-enable__description">
                    {ipfsIpnsDescriptionParts[0]}{' '}
                    <span className="highlight">ipfs://</span>{' '}
                    {ipfsIpnsDescriptionParts[1]}{' '}
                    <span className="highlight">ipns://</span>
                    {ipfsIpnsDescriptionParts[2]}
                  </div>
                  <div className="ipfs-enable__description">
                    {ipfsIpnsExampleParts[0]}{' '}
                    <span className="highlight">ipfs://[CID]/</span>{' '}
                    {ipfsIpnsExampleParts[1]}{' '}
